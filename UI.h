...
const char* captivePortalHTML = R"raw_string(<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <link rel="preload" href="iro.min.js" as="script">
  <link rel="stylesheet" href="styles.css">
</head>

<body>
  <div id="loader" class="loader backdrop-blur">
    <div class="spinner">
      <div class="spinnerin"></div>
    </div>
  </div>

  <nav class="bottom-nav backdrop-blur">
  ...
  <main>
    <section class="color-section">
      <h2 class="visually-hidden">LED Color Selection</h2>
      <label>
      ...
      <div class="swatchGrid" id="swatch-grid">
        <div class="swatch backdrop-blur" data-color="#ff0000"></div>
        <div class="swatch backdrop-blur" data-color="#00FF00"></div>
        <div class="swatch backdrop-blur" data-color="#0000FF"></div>
        <div class="swatch backdrop-blur" data-color="#00FFFF"></div>
        <div class="swatch backdrop-blur" data-color="#FF00FF"></div>
        <div class="swatch backdrop-blur" data-color="#ffffff"></div>
      </div>
    </section>
    ...
    <section class="effects-section">
      ...
      <div class="effects-bar">
        <div class="effect-dropdown">
          <button class="dropdown-toggle backdrop-blur" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-list backdrop-blur" role="menu" aria-label="Effects List">
        ...
        <input type="range" id="effect-speed" class="backdrop-blur" min="1" max="100" value="40">
      </div>
      ...
      <div class="quick-actions">
        ...
        <div class="action-buttons">
          <button class="action-btn backdrop-blur" onclick="quickAction('off')">
          ...
          <button class="action-btn backdrop-blur" onclick="quickAction('solid')">
            <svg class="action-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
              <circle cx="8" cy="8" r="8" />
            </svg>
            <span class="action-text">Solid</span>
          </button>
          <button class="action-btn backdrop-blur" onclick="quickAction('rainbow')">
            <svg class="action-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
              <path
                d="M8 4.5a7 7 0 0 0-7 7 .5.5 0 0 1-1 0 8 8 0 1 1 16 0 .5.5 0 0 1-1 0 7 7 0 0 0-7-7m0 2a5 5 0 0 0-5 5 .5.5 0 0 1-1 0 6 6 0 1 1 12 0 .5.5 0 0 1-1 0 5 5 0 0 0-5-5m0 2a3 3 0 0 0-3 3 .5.5 0 0 1-1 0 4 4 0 1 1 8 0 .5.5 0 0 1-1 0 3 3 0 0 0-3-3m0 2a1 1 0 0 0-1 1 .5.5 0 0 1-1 0 2 2 0 1 1 4 0 .5.5 0 0 1-1 0 1 1 0 0 0-1-1" />
            </svg>
          ...
          <button class="action-btn backdrop-blur" onclick="quickAction('hazard')">
            <svg class="action-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
              <path
                d="M7.938 2.016A.13.13 0 0 1 8.002 2a.13.13 0 0 1 .063.016.15.15 0 0 1 .054.057l6.857 11.667c.036.06.035.124.002.183a.2.2 0 0 1-.054.06.1.1 0 0 1-.066.017H1.146a.1.1 0 0 1-.066-.017.2.2 0 0 1-.054-.06.18.18 0 0 1 .002-.183L7.884 2.073a.15.15 0 0 1 .054-.057m1.044-.45a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767z" />
              <path
    ...
    <div id="popupBox" class="popupBox backdrop-blur" aria-hidden="true" role="dialog" aria-modal="true"
      aria-labelledby="popupTitle" aria-describedby="popupDesc">
      <div class="popupContent backdrop-blur">
    ...
    <div id="notification" class="notification backdrop-blur"></div>
  </main>
